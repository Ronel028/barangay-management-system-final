...
function PermitUpdateModal(){
    return (
        <div className="modal fade" id="update-permit" tabIndex="-1" data-bs-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
